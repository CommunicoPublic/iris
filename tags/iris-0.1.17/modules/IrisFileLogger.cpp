                              ...
                              IRIS::Logger           & oLogger)
{
	...
	{
		oLogger.Emerg("%s/%s: Can't open file `%s`", GetObjectType(), GetObjectName(), sErrorLogFile.c_str());
		return -1;
	}
	...
	{
		oLogger.Emerg("%s/%s: Can't open file `%s`", GetObjectType(), GetObjectName(), sCustomLogFile.c_str());
