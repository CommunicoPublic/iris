...
//
IRIS::NetworkEventWatcher  * IrisEchoHandler::NewConnection(IRIS::AcceptLoopContext  * pContext,
                                                            IRIS::ServiceConfig      * pServiceConfig,
                                                            IRIS::ClientTCPSocket    * pSocket)
{
	using namespace IRIS;

return new IrisEchoEventWatcher(&oWorkerContext, pContext, pServiceConfig, pLoggerObject, pSocket);
}
