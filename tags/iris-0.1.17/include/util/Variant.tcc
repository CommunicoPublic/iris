...
// Type cast constructor
//
template <typename Compare>BasicVariant<Compare>::BasicVariant(const UINT_32  iIValue): eType(INT), iValue(iIValue)
{
	;;
}
...
// Type cast constructor
//
template <typename Compare>BasicVariant<Compare>::BasicVariant(const UINT_64  iIValue): eType(INT), iValue(iIValue)
{
	;;
}
