...
public:
	...
	*/
	ConfigIncludeCallback::State IncludeFile(CCHAR_P szStart, CCHAR_P szEnd);
...
// Constructor
//
FileIncludeCallback::FileIncludeCallback(STLW::vector<STLW::string>  & vIIncludeFiles): vIncludeFiles(vIIncludeFiles)
{
	;;
}
                                                  ...
                                                  Logger                      & oLogger)
{
	...
	FileIncludeCallback oFileIncludeCallback(vIncludeFiles);
