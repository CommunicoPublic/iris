...
// Constructor
//
ServerTCP4SSLSocket::ServerTCP4SSLSocket(const bool       bIStartTLS,
                                         CCHAR_P          szIHost,
...
// Open socket
//
TCPSocket::State ServerTCP4SSLSocket::Open()
{
...
// Close socket
//
TCPSocket::State ServerTCP4SSLSocket::Close()
{
	close(iSocket);
	iSocket = -1;
...
// Bind to the address
//
TCPSocket::State ServerTCP4SSLSocket::Bind()
{
...
//
TCPSocket::State ServerTCP4SSLSocket::Accept(ClientTCPSocket *  & pServerClientSocket)
{
	...
	pServerClientSocket = new ServerClientTCP4SSLSocket(!bStartTLS, iClientSocket, sBuffer, ntohs(sSocketAddress.sin_port));
...
// Get address family
//
TCPSocket::AddressFamily ServerTCP4SSLSocket::GetAddressFamily() const { return INET; }

//
// Destructor
//
ServerTCP4SSLSocket::~ServerTCP4SSLSocket() throw()
{
	Close();
	free(szIP);
	free(szHost);
