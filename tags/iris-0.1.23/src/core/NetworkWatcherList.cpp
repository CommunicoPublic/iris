...
//
NetworkWatcherList::State NetworkWatcherList::RemoveWatcher(NetworkEventWatcher  * pWatcher)
{
...
// Delete all watchers
//
void NetworkWatcherList::RemoveAllWatchers(STLW::vector<NetworkEventWatcher *>  & vContextes)
{
