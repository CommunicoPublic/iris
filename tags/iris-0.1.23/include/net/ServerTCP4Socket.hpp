 ...
 *
 */
#ifndef _SERVER_TCP4_SOCKET_HPP__
#define _SERVER_TCP4_SOCKET_HPP__ 1
...
/**
  @class ServerTCP4Socket TCP4Socket.hpp <TCP4Socket.hpp>
  @brief IPv4 server socket implementation
*/
class ServerTCP4Socket:
...
public:
	/**
	  ...
	  @param iIPort - port
	*/
	ServerTCP4Socket(CCHAR_P        szIHost,
	...
	*/
	...
	/**
	  @brief A destructor
	*/
	virtual ~ServerTCP4Socket() throw();

private:
	// Does not exist
	ServerTCP4Socket(const ServerTCP4Socket & oRhs);
	ServerTCP4Socket & operator=(const ServerTCP4Socket & oRhs);
...
#endif // _SERVER_TCP4_SOCKET_HPP__
// End.
