...
public:
	/**
	  @brief Constructor
	  @param oAcceptLoopContext - Accept loop context
	*/
	NetworkEventWatcher(AcceptLoopContext  & oAcceptLoopContext,
