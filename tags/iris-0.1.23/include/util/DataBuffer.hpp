...
public:
	...
	*/
	DataBuffer & Assign(const DataBuffer  & oRhs);
	...
	*/
	...
	/**
	  @brief Append other data buffer
	  @param  oRhs - nuffer to append
	*/
	DataBuffer & Append(const DataBuffer  & oRhs);
