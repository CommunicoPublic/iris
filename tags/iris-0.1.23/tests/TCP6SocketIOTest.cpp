...
{
	ClientTCPSocket * pClientSocket = new ClientTCP6Socket(C_SERVER_HOST, iServerPort);
	...
	dynamic_cast<ClientTCP6Socket *>(pClientSocket) -> Connect();
...
int main(int argc, char ** argv)
{
	...
	ServerTCPSocket * pServerSocket = new ServerTCP6Socket(C_SERVER_HOST, C_SERVER_PORT);
