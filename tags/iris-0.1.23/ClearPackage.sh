...
rm -fr debian/iris-server0.1-dbg debian/iris-cli0.1 debian/iris-server0.1 debian/iris-configs0.1 debian/libiris-core0.1 debian/iris-dev debian/tmp debian/iris-file-logger0.1 debian/iris-syslog-logger0.1 debian/iris-echo-handler0.1 debian/*.init debian/*.logrotate
