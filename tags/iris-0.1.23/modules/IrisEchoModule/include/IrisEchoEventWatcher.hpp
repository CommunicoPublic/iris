...
public:
	...
	/**
	  @brief Constructor
	  @param oWorkerContext - thread worker context
	  @param oIContext - Accept loop context
	  @param oIServiceConfig - Service configuration
	  @param oLoggerObject - logger module
	  @param pISocket - Client socket
	*/
	IrisEchoEventWatcher(IrisEchoWorkerContext    & oWorkerContext,
	                     IRIS::AcceptLoopContext  & oIContext,
